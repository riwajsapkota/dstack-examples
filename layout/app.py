...
app.output(handler=country_output_handler, label="Companies", depends=[countries])

companies = app.select(handler=get_companies_by_country, label="Company", depends=[countries], colspan=6, rowspan=7)
